		...
		<div class="large-12 columns">
			...
			?>
				...
				<?php esc_html_e( 'All Videos', 'betube' ); ?>&nbsp;:&nbsp;
					<span>
					<?php echo esc_attr($totalPost);?>&nbsp;
					<?php esc_html_e( 'Videos posted', 'betube' ); ?>
					</span>
				</p>
			...
			<div class="text-center row-btn">
				...
				<a class="button radius" href="<?php echo esc_url($currentCatLink); ?>">
					<?php esc_html_e( 'View All Video In', 'betube' ); ?>&nbsp;
					<?php echo esc_attr($currentCatName); ?>
				</a>
				<?php }else{?>
	...
	<section class="content content-with-sidebar">	
		...
		<div class="row">
			<div class="large-12 columns">
				...
				<div class="text-center row-btn">
					<?php if(!empty($currentCatLink)){?>
					<a class="button radius" href="<?php echo esc_url($currentCatLink); ?>"><?php esc_html_e( 'View All Video In', 'betube' ); ?> <?php echo esc_attr($currentCatName); ?></a>
					<?php }else{?>
