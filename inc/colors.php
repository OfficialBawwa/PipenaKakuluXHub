...
function wpcrown_wpcss_head() {
	...
	if(!empty($betubePrimaryColor)) {
		...
		echo esc_attr($betubePrimaryColor);
		echo " !important; } ";
		...
		echo esc_attr($betubePrimaryColor). '#ececec #ececec';
		echo " !important; } ";
	...
	if(!empty($betubeSecondaryColor)) {
		...
		echo esc_attr($betubeSecondaryColor);
		echo " !important; } ";
	...
	if(!empty($betubeBreadcrumbBG)) {
		...
		echo esc_attr($betubeBreadcrumbBG);
		echo "; } ";
	...
	if(!empty($betubeBreadcrumbTXT)) {
		...
		echo esc_attr($betubeBreadcrumbTXT);
		echo " !important; } ";
	...
	if(!empty($betubeVerticalSlider)) {
		...
		echo esc_attr($betubeVerticalSlider);
		echo " !important; } ";
	...
	if(!empty($betubeSideBarColor)) {
		...
		echo esc_attr($betubeSideBarColor);
		echo " !important; } ";
	...
	body#boxed{
		...
		background-color:<?php echo esc_attr($redux_demo['betube_boxed_bg_section']['background-color']); ?> !important;
		background-image:url("<?php echo esc_url($redux_demo['betube_boxed_bg_section']['background-image']); ?>");
		background-repeat:<?php echo esc_attr($redux_demo['betube_boxed_bg_section']['background-repeat']); ?>;
		background-position:<?php echo esc_attr($redux_demo['betube_boxed_bg_section']['background-position']); ?>;
		background-size:<?php echo esc_attr($redux_demo['betube_boxed_bg_section']['background-size']); ?>;
		background-attachment:<?php esc_attr($redux_demo['betube_boxed_bg_section']['background-attachment']); ?>;
		<?php } ?>
	}
	<?php
	/*Boxed Layout*/
