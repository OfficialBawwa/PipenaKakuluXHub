...
$beTubeLogin = betube_get_template_url('template-login.php');
...
?>
<section id="top" class="topBar show-for-large <?php echo esc_attr($topBarBlack); ?>">
	<div class="row">
		<div class="medium-6 columns">
			...
			<div class="socialLinks">
				...
				<a href="<?php echo esc_url($betubeFB);  ?>" target="_blank">
					<i class="fa fa-facebook"></i>
				</a>
				<?php }?>
				
				<?php if(!empty($beTubeTW)){ ?>
				<a href="<?php echo esc_url($beTubeTW);  ?>" target="_blank">
					<i class="fa fa-twitter"></i>
				</a>
				<?php }?>
				
				<?php if(!empty($beTubeGPlus)){ ?>
				<a href="<?php echo esc_url($beTubeGPlus);  ?>" target="_blank">
					<i class="fa fa-google-plus"></i>
				</a>
				<?php }?>
				
				<?php if(!empty($beTubePin)){ ?>
				<a href="<?php echo esc_url($beTubePin);  ?>" target="_blank">
					<i class="fa fa-pinterest-p"></i>
				</a>
				<?php }?>
				
				<?php if(!empty($beTubeLinkedin)){ ?>
				<a href="<?php echo esc_url($beTubeLinkedin);  ?>" target="_blank">
					<i class="fa fa-linkedin"></i>
				</a>
				<?php }?>
				
				<?php if(!empty($beTubeInsta)){ ?>
				<a href="<?php echo esc_url($beTubeInsta);  ?>" target="_blank">
					<i class="fa fa-instagram"></i>
				</a>
				<?php }?>
				
				<?php if(!empty($beTubeYT)) { ?>
				<a href="<?php echo esc_url($beTubeYT); ?>" target="_blank">
					<i class="fa fa-youtube"></i>
				</a>
				<?php } ?>
				
				<?php if(!empty($beTubeVi)) { ?>
				<a href="<?php echo esc_url($beTubeVi); ?>" target="_blank">
					<i class="fa fa-vimeo-square"></i>
				</a>
				<?php } ?>
				
				<?php if(!empty($beTubeDirbb)) { ?>
				<a href="<?php echo esc_url($beTubeDirbb); ?>" target="_blank">
					<i class="fa fa-dribbble"></i>
				</a>
				<?php } ?>
				
				<?php if(!empty($beTubeFlic)) { ?>
				<a href="<?php echo esc_url($beTubeFlic); ?>" target="_blank">
					<i class="fa fa-flickr"></i>
				</a>
				<?php } ?>
				
				<?php if(!empty($beTubeGith)) { ?>
				<a href="<?php echo esc_url($beTubeGith); ?>" target="_blank">
					...
					<li class="dropdown-login">
						...
						<div class="login-form">						
							...
							<?php esc_html_e( 'New here?', 'betube' ); ?>&nbsp;
								<a class="newaccount" href="<?php echo esc_url($beTubeRegister); ?>"><?php esc_html_e( 'Create a new Account', 'betube' ); ?></a>
							</p>
					...
					<li class="dropdown-login">
						...
						<div class="login-form">						
							<p class="text-center topProfilebtn">
								<a class="button expanded" href="<?php echo esc_url($beTubeProfile); ?>"><?php esc_html_e( 'Visit Profile', 'betube' ); ?></a>
							</p>
							<p class="text-center topProfilebtn">
...
<section id="navBar">
		...
		<div class="row">
			...
			<div class="large-6 columns">
				<div class="topCenterAdv text-center">
					<?php echo betube_display_html_ad_code($googleAdsHeaderV6); ?>
				</div>
			</div><!--Google Ads -->
			<div class="large-3 columns">
				<div class="search-btns float-right">
					<ul class="menu">
						<?php if(!empty($beTubeUploadVideo)){?>
						<li class="upl-btn">
							<a href="<?php echo esc_url($beTubeUploadVideo); ?>"><?php esc_html_e( 'Upload Video', 'betube' ); ?></a>
						</li>
						<?php } ?>
						...
						<?php }elseif($beTubeHeaderStyle == "v7" || $beTubeHeaderStyle == "v8"){?>
							<?php if (!is_user_logged_in()) {?>
								...
								<li class="login">
									<a href="<?php echo esc_url($beTubeLogin); ?>">
										<?php esc_html_e( 'Login', 'betube' ); ?>
									</a>
								</li>
								<?php } ?>
							<?php }else{ ?>
	...
	<?php }?>
	<!--Only for HeaderV6-->
	<nav class="sticky-container <?php echo esc_attr($navBlack); ?> <?php echo esc_attr($navFull); ?> <?php echo esc_attr($navFullv2);?> <?php  echo esc_attr($navfullv2light); ?>" data-sticky-container>
		<div class="<?php echo esc_attr($betubeStickyClass); ?> topnav <?php echo esc_attr($divClass);?>" data-sticky data-top-anchor="navBar" data-btm-anchor="footer-bottom:bottom" data-margin-top="0" data-margin-bottom="0" style="width: 100%; background: <?php echo esc_html($background); ?>;" data-sticky-on="large">
		<?php if($beTubeHeaderStyle == "v3" || $beTubeHeaderStyle == "v4"){?>
			...
			<div class="show-for-large topbar-full clearfix <?php echo esc_attr($divClass2); ?>" id="beNav" style="width: 100%;">
				...
				<div class="top-bar-left topnews">
					<div class="newsTicker">
						...
						?>
						<li><a href="<?php the_permalink(); ?>"><?php echo esc_html($theTitle); ?></a></li>
						<?php 
							endforeach;
							wp_reset_postdata();
						?>						
						...
						<ul class="menu float-right">
							...
							<li class="dropdown-login">
								...
								<div class="login-form">						
									...
									<?php if(!empty($beTubeRegister)){?>
									<p class="text-center"><?php esc_html_e( 'New here?', 'betube' ); ?> <a class="newaccount" href="<?php echo esc_url($beTubeRegister); ?>"><?php esc_html_e( 'Create a new Account', 'betube' ); ?></a></p>
									<?php } ?>									
								</div>						
							</li>
							<?php }else{?>
		...
		<?php }else{ ?>
			<div class="row <?php echo esc_attr($beTubeHeaderStyle); ?>">
				<div class="large-12 columns">
					<div class="title-bar <?php echo esc_attr($titlebardark); ?>" data-responsive-toggle="beNav" data-hide-for="large">
						<button class="menu-icon" type="button" data-toggle="<?php echo esc_attr($buttontoggle); ?>"></button>
						<div class="title-bar-title">
						<?php if(!empty($betubeMainLOGO)){?>
							<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
								<img src="<?php echo esc_url($betubeMainLOGO); ?>" alt="<?php bloginfo('name'); ?>" />
					...
					<div class="top-bar show-for-large <?php echo esc_attr($topbarlightdark); ?> <?php echo esc_attr($topbarlight); ?>" id="beNav" style="width: 100%;">
						<?php if($beTubeHeaderStyle == "v6"){?>
							<div class="top-bar-left topnews">
								<div class="newsTicker">
									<i class="fa fa-video-camera"></i>
			...
			<div id="betube-bar" class="clearfix search-bar-light <?php echo esc_attr($searchbardark); ?>">
