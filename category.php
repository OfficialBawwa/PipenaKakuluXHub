...
<section class="category-content">
	...
	<!-- left side content area -->
		<div class="large-8 columns">
					...
					?>
						<div class="medium-8 small-8 columns">
							<div class="head-title">
								...
								<h4><?php echo esc_html($catName);?></h4>
							</div>
						</div><!--End medium-8-->
				...
				<div class="row secBg">
					<div class="large-12 columns">
						<div class="row column head-text clearfix">
							...
							?>
							<p class="pull-left"><?php esc_html_e( 'All Videos', 'betube' ); ?> : <span><?php echo esc_attr($allPosts); ?>&nbsp; <?php esc_html_e( 'Video Posted', 'betube' ); ?></span></p>
			...
			?>
				<div class="googleAdv">
					<?php echo betube_display_html_ad_code($beTubeCatAds); ?>
				</div><!-- End ad Section -->
				<?php }?>
		</div><!--End large-8-->
	<!-- left side content area -->
