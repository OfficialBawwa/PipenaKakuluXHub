	...
	<div class="main-text text-center">
		<div class="row">
			<div class="large-12 columns">
				<h3><?php echo the_author_meta('firsttext', $user_id); ?></h3>
				<h1><?php echo the_author_meta('secondtext', $user_id); ?></h1>
			</div><!--large-12-->
					...
					<div class="widgetBox">
						...
						?>
							<ul class="profile-overview">
								...
								<li class="clearfix">
									<a href="<?php echo esc_url($beTubeallFavourite); ?>">
								...
								<li class="clearfix">
									<a class="active" href="<?php echo esc_url($beTubeallFollowers); ?>">
